...
class tx_powermail_belist {
	...
	function exportIcons() {
		...
		$content .= '<a href="index.php?id='.$this->pid.'&export=xls"><img src="../img/icon_xls.gif" style="margin: 5px;" title="Export to excel file format" /></a>';
		$content .= '<a href="index.php?id='.$this->pid.'&export=csv"><img src="../img/icon_csv.gif" style="margin: 5px;" title="Export to CSV file format" /></a>';
		$content .= '<a href="index.php?id='.$this->pid.'&export=table"><img src="../img/icon_table.gif" style="margin: 5px;" title="Export to HTML table" /></a>';
		$content .= '</div>';
