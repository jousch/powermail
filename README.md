...
<table>
	...
	<tr><td>Release date</td><td>25. March 2008</td></tr>
	<tr><td>Author</td><td>Alexander Kellner, Mischa Heissmann</td></tr>
	<tr><td>Comment</td><td>Saving values to any db table (fe_users, tt_address, ...), noreply email can be set via constants, no more emails no noreply@domain.org</td></tr>
</table>
