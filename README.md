...
<table>
	...
	<tr><td>Release date</td><td>27. March 2008</td></tr>
	<tr><td>Author</td><td>Alexander Kellner, Mischa Heissmann</td></tr>
	<tr><td>Comment</td><td>Preselection of checkboxes, selectorfields and radiobuttons available (see manual), Small fix for already selected countries, CSS corner added to manual (because of the increased demand)</td></tr>
</table>
