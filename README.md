...
<table>
	<tr><td>Version</td><td>0.5.9 beta</td></tr>
	<tr><td>Release date</td><td>15. February 2008</td></tr>
	<tr><td>Author</td><td>Alexander Kellner, Mischa Heissmann</td></tr>
	<tr><td>Comment</td><td>Javascript validation enabled with simulatestaticdocuments, date fields will be prefilled if needed, IP logging can be disabled</td></tr>
</table>
