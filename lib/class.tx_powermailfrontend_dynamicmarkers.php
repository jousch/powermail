...
class tx_powermailfrontend_dynamicmarkers extends tslib_pibase {

    var $extKey = 'powermail_frontend';
    var $scriptRelPath = 'pi1/class.tx_powermailfrontend_pi1.php';    // Path to pi1 to get locallang.xml from pi1 folder
    var $locallangmarker_prefix = array('POWERMAILFE_LL_','powermailfe_ll_'); // prefix for automatic locallangmarker
    var $typoscriptmarker_prefix = array('POWERMAILFE_TS_','dynamicTyposcript'); // prefix for automatic typoscriptmarker
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/powermail_frontend/lib/class.tx_powermailfrontend_dynamicmarkers.php']) {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/powermail_frontend/lib/class.tx_powermailfrontend_dynamicmarkers.php']);
}
