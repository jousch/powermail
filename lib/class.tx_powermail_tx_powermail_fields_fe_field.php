 ...
 */
class tx_powermail_tx_powermail_fields_fe_field {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/powermail/lib/class.tx_powermail_tx_powermail_fields_fe_field.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/powermail/lib/class.tx_powermail_tx_powermail_fields_fe_field.php']);
}
